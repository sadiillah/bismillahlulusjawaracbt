        ...
        <div className="px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-brand-dark text-xs font-normal">Teacher Sidebar</p>
            </div>
          </div>
          {/* Mobile close button */}
          <button
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link
                ...
                onClick={() => onClose()}
                className={`nav-link rounded-[20px] transition-all duration-300 group hover:bg-gray-50 ${
                  location.pathname.startsWith('/dashboard/subjects') ? 'nav-link-active' : ''
                }`}
              >
                <GraduationCap className={`w-5 h-5 transition-colors duration-300 ${
                  location.pathname.startsWith('/dashboard/subjects') ? 'text-white' : 'text-gray-600 group-hover:!text-[#EF3F09]'
                }`} />
                <span className={`text-base font-medium transition-colors duration-300 ${
                  location.pathname.startsWith('/dashboard/subjects') ? 'text-brand-white font-semibold' : 'text-brand-dark group-hover:!text-[#EF3F09]'
                }`}>My Subjects</span>
              </Link>
              ...
              <Link
                ...
                onClick={() => onClose()}
                className={`nav-link rounded-[20px] transition-all duration-300 group hover:bg-gray-50 ${
                  isActive('/dashboard/grades') ? 'nav-link-active' : ''
                }`}
              >
                <Award className={`w-5 h-5 transition-colors duration-300 ${
                  isActive('/dashboard/grades') ? 'text-white' : 'text-gray-600 group-hover:!text-[#EF3F09]'
                }`} />
                <span className={`text-base font-medium transition-colors duration-300 ${
                  isActive('/dashboard/grades') ? 'text-brand-white font-semibold' : 'text-brand-dark group-hover:!text-[#EF3F09]'
                }`}>Grades</span>
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link
                ...
                onClick={() => onClose()}
                className={`nav-link rounded-[20px] transition-all duration-300 group hover:bg-gray-50 ${
                  isActive('/dashboard/reports') ? 'nav-link-active' : ''
                }`}
              >
                <FileText className={`w-5 h-5 transition-colors duration-300 ${
                  isActive('/dashboard/reports') ? 'text-white' : 'text-gray-600 group-hover:!text-[#EF3F09]'
                }`} />
                <span className={`text-base font-medium transition-colors duration-300 ${
                  isActive('/dashboard/reports') ? 'text-brand-white font-semibold' : 'text-brand-dark group-hover:!text-[#EF3F09]'
                }`}>Reports</span>
              </Link> */}
