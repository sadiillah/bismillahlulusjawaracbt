...
// Simplified schema following AddSubject pattern
...
const AddTeacher = () => {
  ...
  const onSubmit = (data: CreateTeacherFormData) => {
    ...
    createTeacher({ ...data, role: 'teacher' }, {
      onSuccess: () => {
        ...
        if (fieldErrors) {
          Object.entries(fieldErrors).forEach(([key, value]) => {
            if (Array.isArray(value) && value.length > 0) {
              setError(key as keyof CreateTeacherFormData, {
                type: 'server',
                message: value[0],
              });
            }
      ...
      <div className="flex-1 ml-64">
        ...
        <div className="mt-[50px] mb-4 ml-[50px]">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-brand-dark font-medium">Add Teacher</span>
          </nav>
        </div>
          ...
          <div className="flex items-center justify-between pl-2 pr-2">
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 relative flex items-center justify-center rounded-[26px] overflow-hidden">
                ...
                <UserCheck className="w-10 h-10 text-[#1F2937] relative z-10" />
              </div>
              <div>
                <h1 className="text-brand-dark text-3xl font-extrabold mb-2">Add New Teacher</h1>
                <p className="text-brand-dark text-base font-normal">Create a new teacher account with role assignment</p>
              </div>
            </div>
            <div>
              <button 
